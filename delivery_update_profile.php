<?php
    ...
    if(isset($_POST['update_profile'])){
        ...
        if(!empty($update_pass) OR !empty($new_pass) AND !empty($confirm_pass)){
            if($update_image != $new_pass){
                $message[]= 'old password not mached!';
            }
            elseif($new_pass != $confirm_pass){
                $message[]= 'confirm password not mached!';
            }
            else{
        ...
        <section class="update-profile">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex-btn">
                    ...
                    <a href="delivery_page.php" class="option-btn">go back</a>
                </div>
            </form>
        </section>
