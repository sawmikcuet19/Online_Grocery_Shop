<?php
    ...
    if(isset($_POST['add_product'])){
        ...
        if($select_products->rowCount() > 0){
            ...
            $insert_products = $conn->prepare("INSERT INTO `products`(name, catagory, details, price, image) VALUES(?,?,?,?,?)");
            $insert_products->execute([$name, $catagory, $details, $price, $image]);

            if($insert_products){
                if($image_size > 2000000){
                    $message[] = 'image size is tpp large!';
                }
                else{
    ...
    <body>
        ...
        <section class="add-products">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <textarea name="details" class="box" required placeholder="enter products details" cols="30" rows="10"></textarea>
